...
router.get(
  "/api/detailedreports/check",
  detailedReportController.checkDetailedReportExists,
);
router.get(
...
router.get(
  "/api/students/:regNumber/report-summary",
  detailedReportController.getStudentReportSummary,
);
router.get(
  "/api/students/:regNumber/testreview",
  detailedReportController.getStudentTestReview,
);
