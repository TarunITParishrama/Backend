...
const deletedStudentSchema = new mongoose.Schema(
  {
    // snapshot of student
    originalId: { type: mongoose.Schema.Types.ObjectId, ref: 'Student', index: true, required: true }, // original _id
    admissionYear: { type: Number, required: true, min: 2022, max: 2028 },
    campus: { type: mongoose.Schema.Types.ObjectId, ref: 'Campus', required: true },
    gender: { type: String, required: true, enum: ['Boy', 'Girl'] },
    admissionType: { type: String, required: true, enum: ['Residential', 'Semi-Residential', 'Non-Residential'] },
    ...
    allotmentType: { type: String, required: true, enum: ['11th PUC', '12th PUC', 'LongTerm'] },
    ...
    deletedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User' }, // optional, if auth middleware sets req.user
  },
  { timestamps: true }
);
